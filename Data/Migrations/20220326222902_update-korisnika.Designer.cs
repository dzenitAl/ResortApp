...
namespace Data.Migrations
{
    ...
    [Migration("20220326222902_update-korisnika")]
    partial class updatekorisnika
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data.EFModels.RezervacijaBazen", b =>
                {
                    b.Property<int>("BazenId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("BazenId", "RezervacijaID");

                    b.HasIndex("RezervacijaID");

                    b.ToTable("RezervacijaBazen");
                });

            modelBuilder.Entity("Data.EFModels.RezervacijaBungalov", b =>
                {
                    b.Property<int>("BungalovId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("BungalovId", "RezervacijaID");

                    b.HasIndex("RezervacijaID");

                    b.ToTable("RezervacijaBungalov");
                });
            ...
            modelBuilder.Entity("Data.EFModels.RezervacijaSala", b =>
                {
                    ...
                    b.HasKey("SalaId", "RezervacijaID");

                    b.HasIndex("RezervacijaID");

                    b.ToTable("RezervacijaSala");
                });
            ...
            modelBuilder.Entity("Data.EFModels.RezervacijaSpaCentar", b =>
                {
                    ...
                    b.HasKey("SpaCentarId", "RezervacijaID");

                    b.HasIndex("RezervacijaID");

                    b.ToTable("RezervacijaSpaCentar");
                });
            ...
            modelBuilder.Entity("Data.EFModels.RezervacijaBazen", b =>
                {
                    b.HasOne("Data.EFModels.Bazen", "Bazen")
                        .WithMany()
            ...
            modelBuilder.Entity("Data.EFModels.RezervacijaSpaCentar", b =>
                {
                    ...
                    b.HasOne("Data.EFModels.SpaCentar", "SpaCentar")
                        .WithMany()
